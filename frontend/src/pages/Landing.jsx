...
import {
    ...
    Star, Users, TrendingUp, Compass, Award, ExternalLink
} from 'lucide-react';
...
function Landing() {
    ...
    return (
        <div className="min-h-screen bg-[#070b14] text-slate-100 font-sans selection:bg-indigo-500/30 relative overflow-x-hidden">
            {/* Ambient Lighting Gradients */}
            <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-indigo-600/15 rounded-full blur-[140px] pointer-events-none -translate-x-1/3 -translate-y-1/3" />
            ...
            {/* 1. Header / Navigation — Wide Bleed */}
            <header className="fixed top-0 w-full z-50 px-6 sm:px-10 lg:px-16 xl:px-20 py-4 bg-[#070b14]/85 backdrop-blur-xl border-b border-slate-800/80 transition-all">
                <div className="max-w-[1680px] mx-auto flex justify-between items-center">
                    {/* Brand Wordmark */}
                    <Link to="/" className="flex items-center gap-3.5 group focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-xl p-1">
                        <div className="w-10 h-10 bg-gradient-to-tr from-indigo-600 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-600/30 group-hover:scale-105 transition-transform">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        <Link to="/register">
                            <Button variant="primary" size="sm" icon={ChevronRight} className="shadow-indigo-600/30">Get Started</Button>
                        </Link>
                    </div>
            ...
            {/* 2. Hero Section — Full-Width Expansive ChronoTask Style */}
            <section className="relative pt-32 sm:pt-36 lg:pt-40 pb-20 px-6 sm:px-10 lg:px-16 xl:px-20 max-w-[1680px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 xl:gap-16 items-center text-left">
                    {/* Left Column (Hero Content, Headings, CTAs & Social Proof) */}
                    <motion.div
                    ...
                    >
                        {/* Status Pill Badge */}
                        <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-semibold uppercase tracking-wider mb-6 shadow-sm">
                            <span className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse" />
                            <span>Intelligent Career Companion v2.0</span>
                        </div>

                        {/* Bold Expansive Headline */}
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight mb-6 leading-[1.08] text-white">
                            Master your job search from <span className="bg-gradient-to-r from-indigo-400 via-purple-300 to-cyan-300 bg-clip-text text-transparent">start to finish.</span>
                        </h1>

                        {/* Subtitle / Lead Paragraph */}
                        <p className="text-base sm:text-lg lg:text-xl text-slate-400 max-w-2xl mb-8 leading-relaxed">
                            Job Seer scores candidate compatibility with explainable 4-factor AI matching, evaluates ATS document readiness, generates factual tailored resumes, and organizes your full application pipeline in one workspace.
                        </p>

                        {/* CTA Buttons */}
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-10">
                            <Link to="/register" className="w-full sm:w-auto">
                                <Button variant="primary" size="lg" icon={ArrowRight} className="w-full sm:w-auto px-8 py-4 text-base font-bold shadow-xl shadow-indigo-600/30">
                                    Get Started Free
                                </Button>
                            </Link>
                            <a href="#how-it-works" className="w-full sm:w-auto">
                                <Button variant="secondary" size="lg" icon={ChevronRight} className="w-full sm:w-auto px-7 py-4 text-base font-semibold">
                                    See How It Works
                                </Button>
                            </a>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-6 pt-6 border-t border-slate-800/80 w-full mb-8">
                            <div className="flex items-center -space-x-2">
                                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-indigo-600 to-purple-600 border-2 border-[#070b14] flex items-center justify-center text-xs font-bold text-white shadow-sm">
                                    AK
                                </div>
                                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-cyan-600 to-blue-600 border-2 border-[#070b14] flex items-center justify-center text-xs font-bold text-white shadow-sm">
                                    SL
                                </div>
                                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-emerald-600 to-teal-600 border-2 border-[#070b14] flex items-center justify-center text-xs font-bold text-white shadow-sm">
                                    MR
                                </div>
                                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-amber-600 to-rose-600 border-2 border-[#070b14] flex items-center justify-center text-xs font-bold text-white shadow-sm">
                                    JD
                                </div>
                                <div className="w-9 h-9 rounded-full bg-slate-800 border-2 border-[#070b14] flex items-center justify-center text-[10px] font-bold text-indigo-400 shadow-sm">
                                    +12k
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="text-xs text-slate-400 mt-0.5">Trusted by software engineers & technical professionals</div>
                            </div>
                        </div>

                        {/* 3 Metric Cards */}
                        <div className="grid grid-cols-3 gap-3.5 sm:gap-5 w-full">
                            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                                <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">4-Factor</div>
                                <div className="text-xs text-slate-400 mt-1">Explainable AI Fit</div>
                            </div>
                            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                                <div className="text-xl sm:text-2xl font-bold text-emerald-400 tracking-tight">90%+</div>
                                <div className="text-xs text-slate-400 mt-1">ATS Scan Readiness</div>
                            </div>
                            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                                <div className="text-xl sm:text-2xl font-bold text-indigo-400 tracking-tight">100%</div>
                                <div className="text-xs text-slate-400 mt-1">Factual Integrity</div>
                            </div>
                        </div>
                    </motion.div>

                    {/* Right Column (High-End Product Mockup with Overlapping Floating Badges) */}
                    <motion.div
                        initial={{ opacity: 0, x: 30 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.6, delay: 0.15 }}
                        className="lg:col-span-6 xl:col-span-6 w-full relative"
                    >
                        {/* Floating Top-Right Pill Badge */}
                        <div className="hidden sm:flex absolute -top-4 -right-2 z-20 items-center gap-2 px-3.5 py-1.5 rounded-xl bg-indigo-950/90 border border-indigo-500/40 text-indigo-300 text-xs font-semibold shadow-xl backdrop-blur-md animate-bounce-slow">
                            <TrendingUp size={14} className="text-indigo-400" />
                            <span>+38% Match Boost with Factual CV</span>
                        </div>

                        {/* Floating Bottom-Left Pill Badge */}
                        <div className="hidden sm:flex absolute -bottom-4 -left-2 z-20 items-center gap-2 px-3.5 py-1.5 rounded-xl bg-emerald-950/90 border border-emerald-500/40 text-emerald-300 text-xs font-semibold shadow-xl backdrop-blur-md">
                            <ShieldCheck size={14} className="text-emerald-400" />
                            <span>ATS Document Health: 96% Passed</span>
                        </div>

                        <Card variant="elevated" className="p-5 sm:p-7 text-left border-slate-800/90 bg-slate-950/90 backdrop-blur-2xl shadow-2xl shadow-indigo-950/60 relative rounded-2xl ring-1 ring-indigo-500/20">
                            {/* Window Header */}
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-5 border-b border-slate-800 gap-3">
                                ...
                                <div className="flex flex-wrap gap-1.5 bg-slate-900/90 p-1 rounded-xl border border-slate-800">
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all flex items-center gap-1.5 ${activeTab === 'match' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'}`}
                                    >
                                        <Target size={13} /> Match Fit
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('ats')}
                                        className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all flex items-center gap-1.5 ${activeTab === 'ats' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'}`}
                                    >
                                        <ShieldCheck size={13} /> ATS Scan
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('tailor')}
                                        className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all flex items-center gap-1.5 ${activeTab === 'tailor' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'}`}
                                    >
                                        <FileText size={13} /> Tailor CV
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('kanban')}
                                        className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all flex items-center gap-1.5 ${activeTab === 'kanban' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'}`}
                                    >
                            ...
                            <div className="pt-5 min-h-[300px]">
                                {activeTab === 'match' && (
                                    <div className="space-y-4 animate-fade-in">
                                        <div className="flex justify-between items-center p-4 bg-indigo-950/30 border border-indigo-500/25 rounded-xl">
                                            <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="p-3.5 bg-slate-900/70 rounded-xl border border-slate-800/90">
                                ...
                                {activeTab === 'ats' && (
                                    <div className="space-y-4 animate-fade-in">
                                        <div className="flex items-center justify-between p-4 bg-emerald-950/25 border border-emerald-500/25 rounded-xl">
                                            <div className="flex items-center gap-3.5">
                                                <div className="w-11 h-11 bg-emerald-500/20 text-emerald-400 rounded-xl flex items-center justify-center font-black text-lg">
                                                    96%
                                                </div>
                                                <div>
                                        ...
                                        <div className="space-y-2.5 text-xs">
                                            <div className="p-3 bg-slate-900/70 rounded-xl border border-slate-800/90 flex items-center justify-between">
                                            ...
                                            <div className="p-3 bg-slate-900/70 rounded-xl border border-slate-800/90 flex items-center justify-between">
                                                ...
                                                <span className="text-indigo-300 font-bold">7 / 7 Technical Domains</span>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {activeTab === 'tailor' && (
                                    <div className="space-y-3.5 animate-fade-in font-mono text-xs">
                                        ...
                                        <div className="text-rose-300 bg-rose-500/10 p-3 rounded-lg border border-rose-500/20 leading-relaxed">
                                ...
                                {activeTab === 'kanban' && (
                                    <div className="grid grid-cols-3 gap-3 animate-fade-in">
                                        ...
                                        <div className="p-3 bg-slate-900/80 rounded-xl border border-slate-800">
                                            ...
                                            <div className="p-2.5 bg-slate-950 rounded-lg border border-indigo-500/30 text-xs">
                                        ...
                                        <div className="p-3 bg-slate-900/80 rounded-xl border border-slate-800">
                                            ...
                                            <div className="p-2.5 bg-slate-950 rounded-lg border border-emerald-500/30 text-xs">
            ...
            {/* 3. Value Strip (Wide Bleed Left-to-Right) */}
            <section className="py-14 px-6 sm:px-10 lg:px-16 xl:px-20 border-y border-slate-800/80 bg-slate-950/40">
                <div className="max-w-[1680px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
                    <div className="flex items-start gap-4">
                        <div className="w-11 h-11 bg-indigo-600/10 text-indigo-400 rounded-xl flex items-center justify-center shrink-0 border border-indigo-500/20">
                            <Target size={20} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <div className="w-11 h-11 bg-emerald-600/10 text-emerald-400 rounded-xl flex items-center justify-center shrink-0 border border-emerald-500/20">
                            <ShieldCheck size={20} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <div className="w-11 h-11 bg-cyan-600/10 text-cyan-400 rounded-xl flex items-center justify-center shrink-0 border border-cyan-500/20">
                            <Clock size={20} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <div className="w-11 h-11 bg-purple-600/10 text-purple-400 rounded-xl flex items-center justify-center shrink-0 border border-purple-500/20">
                            <Layers size={20} />
                        </div>
                        <div>
            ...
            {/* 4. Problem & Solution Section (Wide Bleed Left-Aligned) */}
            <section id="why-job-seer" className="py-24 px-6 sm:px-10 lg:px-16 xl:px-20 max-w-[1680px] mx-auto text-left">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Without Job Seer */}
                    <Card variant="flat" className="p-8 sm:p-10 border-rose-500/20 bg-slate-950/60 rounded-2xl">
                        <div className="flex items-center gap-3.5 mb-6">
                            <div className="w-11 h-11 bg-rose-500/10 text-rose-400 rounded-xl flex items-center justify-center font-bold border border-rose-500/20">
                                <X size={22} />
                            </div>
                    ...
                    {/* With Job Seer */}
                    <Card variant="elevated" className="p-8 sm:p-10 border-indigo-500/30 bg-indigo-950/20 shadow-xl shadow-indigo-950/30 rounded-2xl ring-1 ring-indigo-500/20">
                        <div className="flex items-center gap-3.5 mb-6">
                            <div className="w-11 h-11 bg-emerald-500/20 text-emerald-400 rounded-xl flex items-center justify-center font-bold border border-emerald-500/30">
                                <Check size={22} />
                            </div>
            ...
            {/* 5. How It Works (Wide Bleed 5-Step Progression) */}
            <section id="how-it-works" className="py-24 px-6 sm:px-10 lg:px-16 xl:px-20 max-w-[1680px] mx-auto border-t border-slate-800/60 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
                    <Card variant="glass" className="p-6 relative rounded-2xl">
            ...
            {/* 6. Built-in Features (Wide Bento Spotlight Grid) */}
            ...
            {/* 7. FAQ Accordion (Wide Left-Aligned) */}
            <section id="faq" className="py-24 px-6 sm:px-10 lg:px-16 xl:px-20 max-w-[1680px] mx-auto border-t border-slate-800/60 text-left">
                ...
                <div className="space-y-4 max-w-5xl">
                    {faqItems.map((item, index) => (
                        <Card key={index} variant="glass" className="overflow-hidden rounded-2xl">
                            <button
            ...
            {/* 8. Call to Action Banner (Full-Width Asymmetric) */}
            <section className="py-20 px-6 sm:px-10 lg:px-16 xl:px-20 max-w-[1680px] mx-auto">
                <Card variant="elevated" className="p-8 sm:p-12 lg:p-16 border-indigo-500/30 bg-gradient-to-r from-slate-950 via-indigo-950/60 to-slate-950 relative overflow-hidden shadow-2xl shadow-indigo-950/60 text-left rounded-3xl ring-1 ring-indigo-500/20">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3.5 justify-end">
                            <Link to="/register" className="w-full">
                                <Button variant="primary" size="lg" icon={ArrowRight} className="w-full justify-center py-4 text-base font-bold shadow-xl shadow-indigo-600/30">
                                    Get Started Free
                                </Button>
                            </Link>
                            <Link to="/login" className="w-full">
                                <Button variant="secondary" size="lg" className="w-full justify-center py-4 text-base font-semibold">
                                    Sign In to Account
                                </Button>
                            </Link>
                        </div>
