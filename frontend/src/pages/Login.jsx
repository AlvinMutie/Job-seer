...
import { Mail, Lock, AlertCircle, ArrowRight, ArrowLeft, Eye, EyeOff, ShieldCheck, Target, Sparkles, CheckCircle2 } from 'lucide-react';
...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] text-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-10 font-sans selection:bg-indigo-500/30 relative overflow-hidden">
            ...
            {/* Main Auth Container */}
            <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 rounded-3xl bg-white border border-slate-200 shadow-2xl shadow-slate-200/60 overflow-hidden z-10">
                    ...
                    <div>
                        ...
                        <div className="space-y-3.5">
                            <div className="flex items-center gap-3 text-xs sm:text-sm">
                                <div className="w-6 h-6 rounded-lg bg-emerald-400/20 text-emerald-300 flex items-center justify-center shrink-0 border border-emerald-400/30">
                                    <Target size={14} />
                                </div>
                                <span className="font-semibold text-indigo-50">4-Factor Match Rationale</span>
                            </div>

                            <div className="flex items-center gap-3 text-xs sm:text-sm">
                                <div className="w-6 h-6 rounded-lg bg-cyan-400/20 text-cyan-300 flex items-center justify-center shrink-0 border border-cyan-400/30">
                                    <ShieldCheck size={14} />
                                </div>
                                <span className="font-semibold text-indigo-50">10-Layer ATS Health Scan</span>
                            </div>

                            <div className="flex items-center gap-3 text-xs sm:text-sm">
                                <div className="w-6 h-6 rounded-lg bg-purple-400/20 text-purple-300 flex items-center justify-center shrink-0 border border-purple-400/30">
                                    <CheckCircle2 size={14} />
                                </div>
                                <span className="font-semibold text-indigo-50">Live Adzuna Sync Integration</span>
                            </div>
                        </div>
                    </div>

                    <div className="pt-6 border-t border-white/15 text-xs text-indigo-200 mt-8">
                    ...
                    <div>
                        <div className="mb-8">
                            ...
                            <p className="text-sm font-medium text-slate-600 mt-1">
                                Access your personalized job search workspace
                            </p>
                        </div>
